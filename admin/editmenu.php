...
if(isset($_POST['submit'])) {
    ...
    if(empty($namaMenu) || empty($harga)) {
        echo "<script>alert('Nama Menu dan Harga tidak boleh kosong')</script>";
    } else {
...
<body>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form method="POST" onsubmit="return validateForm()">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="harga" name="harga" value="<?php echo $harga; ?>" placeholder="Harga Menu" >
    ...
    <script>
        function validateForm() {
            ...
            if (namaMenu.trim() == "" || harga.trim() == "") {
                alert("Nama Menu dan Harga tidak boleh kosong");
                return false;
            }
            return true;
        }
