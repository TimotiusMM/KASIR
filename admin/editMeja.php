...
if(isset($_POST['submit'])) {
    ...
    if(empty($kodeMeja) || empty($keterangan)) {
        echo "<script>alert('Kode Meja dan Keterangan tidak boleh kosong')</script>";
    } else {
...
<script>
    function validateForm() {
        ...
        if (kodeMeja.trim() == "" || keterangan.trim() == "") {
            alert("Kode Meja dan Keterangan tidak boleh kosong");
            return false;
        }
        return true;
    }
